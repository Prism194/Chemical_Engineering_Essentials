...
1\. 카르노 기관의 사이클 순서
1\) 차가운 열 저장고(Tc)와 동일한 온도인 계가 단열 압축 과정을 통해 TH로 상승
2\) TH인 계가 뜨거운 열 저장고로부터 QH 열을 전달밪고, 등온팽창
3\) 그리고 1단계의 반대방향으로 단열팽창을 통해서 온도가 다시 Tc로 하강
4\) 이후 차가운 열 저장고와 접촉을 유지하면서, 가역 등온 과정을 통해 Qc만큼의